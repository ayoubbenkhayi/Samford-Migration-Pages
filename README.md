...
1. Add a tomcat v6.0 server to the Eclipse
  ...
  e) Click Browse and locate the "tomcat" folder inside of this Samford Migration Pages project
  f) Click Finish
...
2. Configure the server
  ...
  c) In "Deploy path" field, click Browse... and browse for the Tomcat folder inside of your USamford Migration Pages project
