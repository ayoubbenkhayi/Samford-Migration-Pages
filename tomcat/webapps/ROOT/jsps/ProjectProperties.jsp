...
<html lang="en">
  <head>
		<meta charset="utf-8">    
		<title>Samford Migration Pages</title>
	...
	<body>
		<div class="mt-header">
      <div class="container">
        <h1 class="brand">Cascade Server <span>Samford Migration Pages</span></h1>
      </div>
    </div>
          ...
          <form action="/ProjectProperties" method="POST" class="form-horizontal">
            <fieldset>
              <div class="control-group">
                <label class="control-label" for="url">Cascade Server 7.14.x URL</label>
                <div class="controls">
